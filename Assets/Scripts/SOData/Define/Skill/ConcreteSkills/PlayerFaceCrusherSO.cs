...
public class PlayerFaceCrusherSO : PlayerSkillSO
{
    ...
    private IEnumerator FaceCrusherRoutine(PlayerController player)
    {
        ...
        DamageInfo baseInfo = new DamageInfo(baseDamage, ResolveDamageType(), player.gameObject, false, 1f, false, "Face Crusher!");
        ...
        DamageInfo bonusInfo = new DamageInfo(bonusDamage, ResolveDamageType(), player.gameObject, false, 1f, false, "Face Crusher (Center)!");
